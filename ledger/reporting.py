...
def overview(db):
    ...
    return {'invoices': rows, 'unmatched_payments': unmatched, 'summary': {
        ...
        # Improvement: lets the owner see that what they're viewing is current,
        # not a stale page left open from an earlier session (BUSINESS_RULES.md
        # "the owner needs a register they can trust"). Additive field only;
        # existing fields and routes are unchanged.
